...
كلام مونو بـ٦٤ كيلوبت بالثانية نقي تماماً وبينزل عشرة أضعاف. الأداة
بتلمس يلي فوق ٤٠ ميغا بس — إعادة الترميز بتخسّر، وما في سبب تخسّر ملفّ
حجمه منيح أصلاً. وفحص بـ`tests/tools.sh` بيمنع رجوع الكبير.
