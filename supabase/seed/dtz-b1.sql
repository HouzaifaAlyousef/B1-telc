...
from (values
    ('hv1', 'Hören', 'Hören, Teil 1', 6, 'Sie hören vier Ansagen. Zu jeder Ansage gibt es eine Aufgabe. Welche Lösung (a, b oder c) passt am besten?', 'mc', '{"maxPoints": 4, "availablePoints": 4, "missing": 0, "pointsPerItem": 1}'::jsonb, 0),
    ('hv2', 'Hören', 'Hören, Teil 2', 7, 'Sie hören fünf Ansagen aus dem Radio. Zu jeder Ansage gibt es eine Aufgabe. Welche Lösung (a, b oder c) passt am besten?', 'mc', '{"maxPoints": 5, "availablePoints": 5, "missing": 0, "pointsPerItem": 1}'::jsonb, 1),
    ('hv3', 'Hören', 'Hören, Teil 3', 8, 'Sie hören vier Gespräche. Zu jedem Gespräch gibt es zwei Aufgaben. Entscheiden Sie bei jedem Gespräch, ob die Aussage dazu richtig oder falsch ist und welche Antwort (a, b oder c) am besten passt.', 'mc', '{"maxPoints": 8, "availablePoints": 8, "missing": 0, "pointsPerItem": 1}'::jsonb, 2),
    ('hv4', 'Hören', 'Hören, Teil 4', 4, 'Sie hören Aussagen zu einem Thema. Welcher der Sätze a–f passt zu den Aussagen 18–20?', 'matching', '{"bank": [{"key": "A", "text": "Für die Erziehung sind nur die Eltern verantwortlich."}, {"key": "B", "text": "Kinder lernen auch im Kindergarten sehr viel."}, {"key": "C", "text": "Kinder unter drei Jahren sollten zu Hause bleiben."}, {"key": "D", "text": "Kleinkinder lernen am besten von ihren Müttern."}, {"key": "E", "text": "Nicht jedes Kind braucht einen Kindergartenplatz."}, {"key": "F", "text": "Schon kleine Kinder brauchen Kontakt zu anderen Kindern."}], "bankTitle": "Aussagen", "maxPoints": 3, "availablePoints": 3, "missing": 0, "pointsPerItem": 1}'::jsonb, 3),
...
from (values
    ('hv1', 'Hören', 'Hören, Teil 1', 6, 'Sie hören vier Ansagen. Zu jeder Ansage gibt es eine Aufgabe. Welche Lösung (a, b oder c) passt am besten?', 'mc', '{"maxPoints": 4, "availablePoints": 4, "missing": 0, "pointsPerItem": 1}'::jsonb, 0),
    ('hv2', 'Hören', 'Hören, Teil 2', 5, 'Sie hören fünf Ansagen aus dem Radio. Zu jeder Ansage gibt es eine Aufgabe. Welche Lösung (a, b oder c) passt am besten?', 'mc', '{"maxPoints": 5, "availablePoints": 5, "missing": 0, "pointsPerItem": 1}'::jsonb, 1),
    ('hv3', 'Hören', 'Hören, Teil 3', 9, 'Sie hören vier Gespräche. Zu jedem Gespräch gibt es zwei Aufgaben. Entscheiden Sie bei jedem Gespräch, ob die Aussage dazu richtig oder falsch ist und welche Antwort (a, b oder c) am besten passt.', 'mc', '{"maxPoints": 8, "availablePoints": 8, "missing": 0, "pointsPerItem": 1}'::jsonb, 2),
...
from (values
    ...
    ('hv3', '10', 'Frau Meybohm spricht mit ihrem Lehrer. richtig falsch', null::jsonb, 1, null::jsonb, 0),
    ...
    ('hv3', '12', 'Frau Bathily möchte ein Konto eröffnen. richtig falsch', null::jsonb, 1, null::jsonb, 2),
    ...
    ('hv3', '14', 'Tanja möchte einen Computer kaufen. richtig falsch', null::jsonb, 1, null::jsonb, 4),
    ...
    ('hv3', '16', 'Michael lädt Jasmin ins Kino ein. richtig falsch', null::jsonb, 1, null::jsonb, 6),
    ...
    ('lv3', '31', 'In der Kaiserpfalz-Realschule lernen die Schüler Englisch nur über das Theaterspielen. richtig falsch', null::jsonb, 1, null::jsonb, 0),
    ...
    ('lv3', '33', 'Den Führerschein mit 17 kann man in ganz Deutschland machen. richtig falsch', null::jsonb, 1, null::jsonb, 2),
    ...
    ('lv3', '35', 'Die Bank bietet jungen Leuten ein kostenloses Konto an. richtig falsch', null::jsonb, 1, null::jsonb, 4),
...
from (values
    ('hv1', 'Hören', 'Hören, Teil 1', 6, 'Sie hören vier Ansagen. Zu jeder Ansage gibt es eine Aufgabe. Welche Lösung (a, b oder c) passt am besten?', 'mc', '{"maxPoints": 4, "availablePoints": 4, "missing": 0, "pointsPerItem": 1}'::jsonb, 0),
    ('hv2', 'Hören', 'Hören, Teil 2', 5, 'Sie hören fünf Ansagen aus dem Radio. Zu jeder Ansage gibt es eine Aufgabe. Welche Lösung (a, b oder c) passt am besten?', 'mc', '{"maxPoints": 5, "availablePoints": 5, "missing": 0, "pointsPerItem": 1}'::jsonb, 1),
    ('hv3', 'Hören', 'Hören, Teil 3', 7, 'Sie hören vier Gespräche. Zu jedem Gespräch gibt es zwei Aufgaben. Entscheiden Sie bei jedem Gespräch, ob die Aussage dazu richtig oder falsch ist und welche Antwort (a, b oder c) am besten passt.', 'mc', '{"maxPoints": 8, "availablePoints": 8, "missing": 0, "pointsPerItem": 1}'::jsonb, 2),
...
from (values
    ...
    ('hv3', '10', 'Das Gespräch findet in Norwegen statt.', null::jsonb, 1, null::jsonb, 0),
    ...
    ('hv3', '12', 'Frau Baier und Herr Steiner sind Kollegen.', null::jsonb, 1, null::jsonb, 2),
    ...
    ('hv3', '14', 'Frau Melnik telefoniert mit dem Lehrer ihrer Tochter.', null::jsonb, 1, null::jsonb, 4),
    ...
    ('hv3', '16', 'Frau Keller ist in einem Lebensmittelgeschäft.', null::jsonb, 1, null::jsonb, 6),
    ...
    ('lv3', '31', 'Die KKB Krankenkasse bezahlt ihren Mitgliedern einen Kurs im Fitness-Club.', null::jsonb, 1, null::jsonb, 0),
    ...
    ('lv3', '33', 'Kinder sollen immer den kürzesten Weg zur Schule nehmen.', null::jsonb, 1, null::jsonb, 2),
    ...
    ('lv3', '35', 'Die Firma Teletronica GmbH kann auch an einem anderen Termin kommen.', null::jsonb, 1, null::jsonb, 4),
    ...
    ('lv4', '37', 'Die Ware wird immer innerhalb von fünf Werktagen geliefert.', null::jsonb, 1, null::jsonb, 0),
    ('lv4', '38', 'Die Ware wird an Kunden in der ganzen Welt verschickt.', null::jsonb, 1, null::jsonb, 1),
    ('lv4', '39', 'Bei Rücksendung der Ware muss der Kunde in bestimmten Fällen das Porto selbst bezahlen.', null::jsonb, 1, null::jsonb, 2),
...
from (values
    ...
    ('hv3', '10', 'Die Personen sind Nachbarn.', null::jsonb, 1, null::jsonb, 0),
    ...
    ('hv3', '12', 'Herr Huber sucht Arbeit.', null::jsonb, 1, null::jsonb, 2),
    ...
    ('hv3', '14', 'Die Frau und der Mann sind Arbeitskollegen.', null::jsonb, 1, null::jsonb, 4),
    ...
    ('hv3', '16', 'Die Gastherme von Frau Schuster ist kaputt.', null::jsonb, 1, null::jsonb, 6),
    ...
    ('lv3', '31', 'Herr Berger möchte Ruhe in der Nacht.', null::jsonb, 1, null::jsonb, 0),
    ...
    ('lv3', '33', 'Frau Baumgartner hört bald auf zu arbeiten.', null::jsonb, 1, null::jsonb, 2),
    ...
    ('lv3', '35', 'Herr Sanchez hat seine Versicherung gekündigt.', null::jsonb, 1, null::jsonb, 4),
    ...
    ('lv4', '37', 'Auch Schwangere dürfen die Tabletten nehmen.', null::jsonb, 1, null::jsonb, 0),
    ('lv4', '38', 'Ein 13-jähriges Kind darf eine Tablette pro Tag nehmen.', null::jsonb, 1, null::jsonb, 1),
    ('lv4', '39', 'Man soll die Tabletten vor dem Essen nehmen.', null::jsonb, 1, null::jsonb, 2),
...
from (values
    ...
    ('hv3', '10', 'Herr Hamann spricht mit seiner Chefin.', null::jsonb, 1, null::jsonb, 0),
    ...
    ('hv3', '12', 'Herr Förster und Frau Knauer sind Freunde.', null::jsonb, 1, null::jsonb, 2),
    ...
    ('hv3', '14', 'Melanie und Leo lernen zusammen Russisch.', null::jsonb, 1, null::jsonb, 4),
    ('hv3', '15', 'Was soll Melanie mitbringen?', '[{"key": "A", "text": "Musik-CDs."}, {"key": "B", "text": "Eine DVD."}, {"key": "C", "text": "Bilder."}]'::jsonb, 1, null::jsonb, 5),
    ('hv3', '16', 'Margit ist im Reisebüro.', null::jsonb, 1, null::jsonb, 6),
    ...
    ('lv3', '31', 'Die Stadt Nordhausen verkauft billige Fahrkarten für Familien.', null::jsonb, 1, null::jsonb, 0),
    ...
    ('lv3', '33', 'Das Leseprogramm ist für Eltern und Kindern.', null::jsonb, 1, null::jsonb, 2),
    ...
    ('lv3', '35', 'Die Versicherung bezahlt einen Teil der Kosten.', null::jsonb, 1, null::jsonb, 4),
    ...
    ('lv4', '37', 'Man kann auf den Anrufbeantworter sprechen, wenn Sie telefonieren.', null::jsonb, 1, null::jsonb, 0),
    ('lv4', '38', 'Sie können die Nachrichten nur zu Hause anhören.', null::jsonb, 1, null::jsonb, 1),
    ('lv4', '39', 'Sie bekommen eine SMS über eine neue Nachricht, wenn Sie eine Gebühr bezahlt haben.', null::jsonb, 1, null::jsonb, 2),
...
from (values
    ...
    ('hv3', '10', 'Sonja und ihr Mann haben eine neue Wohnung gemietet.', null::jsonb, 1, null::jsonb, 0),
    ...
    ('hv3', '12', 'Frau Schmidt möchte ein Konto eröffnen.', null::jsonb, 1, null::jsonb, 2),
    ...
    ('hv3', '14', 'Anette und Claudia planen ein Hoffest.', null::jsonb, 1, null::jsonb, 4),
    ...
    ('hv3', '16', 'Frau Klein und Frau Maier sprechen über einen neuen Mitarbeiter.', null::jsonb, 1, null::jsonb, 6),
    ...
    ('lv3', '31', 'Die Polizei Hessens möchte, dass mehr Ausländer bei ihr arbeiten.', null::jsonb, 1, null::jsonb, 0),
    ...
    ('lv3', '33', 'Die Schule plant ein Fest, weil die neue Cafeteria fertig ist.', null::jsonb, 1, null::jsonb, 2),
    ...
    ('lv3', '35', 'Der Fahrradkeller ist zu voll.', null::jsonb, 1, null::jsonb, 4),
    ...
    ('lv4', '37', 'Normalerweise müssen Sie Ihr Handy mindestens drei Monate vor Ende des Vertrags kündigen.', null::jsonb, 1, null::jsonb, 0),
    ('lv4', '38', 'Sie müssen bei einer Kündigung immer auch Gründe für die Kündigung angeben.', null::jsonb, 1, null::jsonb, 1),
    ('lv4', '39', 'Die Mitnahme der alten Handynummer ist kostenlos.', null::jsonb, 1, null::jsonb, 2),
...
from (values
    ...
    ('lv3', '31', 'Viele Mieter sind unzufrieden.', null::jsonb, 1, null::jsonb, 0),
    ...
    ('lv3', '33', 'Es ist wichtig, dass Eltern aller Schüler zum Elternabend kommen.', null::jsonb, 1, null::jsonb, 2),
    ...
    ('lv3', '35', 'Durch diese Pressemitteilung will die GEZ die Verbraucher warnen.', null::jsonb, 1, null::jsonb, 4),
    ...
    ('lv4', '37', 'Für das Telefonbanking muss der Kunde außer den Telefonkosten nichts bezahlen.', null::jsonb, 1, null::jsonb, 0),
    ('lv4', '38', 'Nicht jede Überweisung ist mit dem Telefonbanking möglich.', null::jsonb, 1, null::jsonb, 1),
    ('lv4', '39', 'Der Kunde bekommt jeden Monat Vordrucke und Formulare zugeschickt.', null::jsonb, 1, null::jsonb, 2),
...
from (values
    ...
    ('lv3', '31', 'Am 24. April kann man in der Peter Petersen Grundschule günstig Sachen kaufen.', null::jsonb, 1, null::jsonb, 0),
    ...
    ('lv3', '33', 'Im Haus werden alle Gasöfen ausgetauscht. Die Firma Bauer kommt in den nächsten Tagen vorbei.', null::jsonb, 1, null::jsonb, 2),
    ...
    ('lv3', '35', 'Die Kurse kann man auch besuchen, wenn man schon eine Arbeit hat.', null::jsonb, 1, null::jsonb, 4),
    ...
    ('lv4', '37', 'Wenn ein Teilnehmer seine Anmeldung zurücknehmen möchte, muss er immer mindestens zehn Euro bezahlen.', null::jsonb, 1, null::jsonb, 0),
    ('lv4', '38', 'Man kann sich nicht mehr ummelden, wenn ein Kurs angefangen hat.', null::jsonb, 1, null::jsonb, 1),
    ('lv4', '39', 'Die VHS stellt für ihre Kurse automatisch Teilnahmebescheinigungen aus.', null::jsonb, 1, null::jsonb, 2),
...
from (values
    ...
    ('lv3', '31', 'Familie Kowalski hat im letzten Jahr zu viel an die Mainstrom AG gezahlt.', null::jsonb, 1, null::jsonb, 0),
    ...
    ('lv3', '33', 'Die Schule sucht Kinder für die Hausaufgabenbetreuung.', null::jsonb, 1, null::jsonb, 2),
    ...
    ('lv3', '35', 'Beim Projekt Mixopolis haben Jugendliche die Möglichkeit, sich im Internet gegenseitig von ihren Erfahrungen und Problemen zu berichten.', null::jsonb, 1, null::jsonb, 4),
    ...
    ('lv4', '37', 'Die Teilzahlungen sind nur zinsfrei, wenn Sie Ihre Zahnarztrechnung innerhalb von 30 Tagen bezahlen.', null::jsonb, 1, null::jsonb, 0),
    ('lv4', '38', 'Wenn Sie länger als sechs Monate bezahlen, entstehen Ihnen neben den Zinsen noch weitere Kosten.', null::jsonb, 1, null::jsonb, 1),
    ('lv4', '39', 'Sie können selbst festlegen, an welchem Tag im Monat Sie die Raten zahlen möchten.', null::jsonb, 1, null::jsonb, 2),
