...
from (values
    ...
    ('sb2', '33', 'F', 'Das Wort lautet: KEINE'),
...
from (values
    ...
    ('lv2', '9', 'Frau Slata Tanasic', '[{"key": "A", "text": "arbeitet seit 41 Jahren in der gleichen Firma."}, {"key": "B", "text": "erledigt alle Arbeiten mit der linken Hand."}, {"key": "C", "text": "ist seit 21 Jahren an der gleichen Maschine beschäftigt."}]'::jsonb, 5, null::jsonb, 3),
...
from (values
    ...
    ('sb2', 'Sprachbausteine', 'Sprachbausteine, Teil 2', 15, 'Lesen Sie den Text und schließen Sie die Lücken 31–40. Benutzen Sie die Wörter aus der Liste. Jedes Wort passt nur einmal.', 'wordbank', '{"bank": [{"key": "A", "text": "AUCH"}, {"key": "B", "text": "AUFTRAG"}, {"key": "C", "text": "BESCHREIBEN"}, {"key": "D", "text": "FRAGEN"}, {"key": "E", "text": "GEEIGNET"}, {"key": "F", "text": "GEGENÜBER"}, {"key": "G", "text": "INFORMATIONEN"}, {"key": "H", "text": "KÖNNTEN"}, {"key": "I", "text": "STATTFINDEN"}, {"key": "J", "text": "SUCHEN"}, {"key": "K", "text": "TERMIN"}, {"key": "L", "text": "TOUR"}, {"key": "M", "text": "VOR"}, {"key": "N", "text": "WÄREN"}, {"key": "O", "text": "WEIL"}], "bankTitle": "Wörterliste", "passages": [{"paragraphs": [{"t": "3. anach an", "b": false}, {"t": "Obwohl sondern bei", "b": false}, {"t": "B B", "b": false}, {"t": "Nämlich sonst vor", "b": false}, {"t": "C C", "b": false}, {"t": ") (", "b": false}, {"t": "Sehr geehrte Damen und Herren,", "b": false}, {"t": "unsere Organisation hat den (31) , eine deutsch-französische Konferenz zu europäischen", "b": false}, {"t": "Entwicklungsprogrammen vorzubereiten.", "b": false}, {"t": "Diese Veranstaltung könnte in Breisach (32) , und daher brauchen wir von Ihnen nähere(33). In Ihrer Anzeige (34) Sie die Sehenswürdigkeiten von Breisach und die verschiedenen touristischen Möglichkeiten. Deshalb erscheint uns Ihre Stadt als sehr (35) , auch (36) sie als Brücke zu Europa gilt.", "b": false}, {"t": "Nun haben wir folgende Bitte: Für diese Veranstaltung (37) wir ein gutes Hotel, möglichst am Ufer des Rheins, mit Konferenz- und Arbeitsräumen, ausgestattet mit den notwendigen technischen Anlagen, Internetanschluss usw. Es sollte (38) ruhig gelegen sein. Können Sie uns dazu Vorschläge schicken? Der (39) wäre 15.-21. November. Bitte geben Sie uns möglichst bald Bescheid. Für Prospekte und Informationen zu Preisen und Buchungsbedingungen(40) wir Ihnen dankbar. Mit freundlichen Grüßen", "b": false}, {"t": "ADRIAN SCHÖLLER EVD Trans GmbH", "b": false}]}], "maxPoints": 15, "availablePoints": 15, "missing": 0, "pointsPerItem": 1.5}'::jsonb, 4),
