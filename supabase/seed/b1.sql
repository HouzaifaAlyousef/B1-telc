...
from (values
    ...
    ('lv2', '6', 'Die Sendung mit der Maus', '[{"key": "A", "text": "erhält Post aus der ganzen Welt."}, {"key": "B", "text": "hat es schwer, noch neue Themen zu finden."}, {"key": "C", "text": "nimmt nur Vorschläge von Kindern an."}]'::jsonb, 5, null::jsonb, 0),
    ('lv2', '7', 'Die Maus', '[{"key": "A", "text": "erzählt die Sachgeschichten."}, {"key": "B", "text": "wird in einer Werbefirma gezeichnet."}, {"key": "C", "text": "wurde von Friedrich Streich erfunden."}]'::jsonb, 5, null::jsonb, 1),
    ('lv2', '8', 'Das Thema der Ausstellung', '[{"key": "A", "text": "ist die Geschichte der Sendung mit der Maus."}, {"key": "B", "text": "ist 30 Jahre Junges Museum."}, {"key": "C", "text": "sind Kinder aus aller Welt."}]'::jsonb, 5, null::jsonb, 2),
